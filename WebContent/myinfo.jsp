    ...
    <div class="wrapper clearfix">
        <div class="myinfo-outer">
            <div class="aside">
                ...
                <a href=""><i class="i2"></i>我的头像</a>
                <a href=""><i class="i3"></i>绑定设置</a>
                <a href=""><i class="i4"></i>账号安全</a>
                <a href=""><i class="i5"></i>我的窝设置</a>
                <a href=""><i class="i6"></i>黑名单管理</a>
                <a href=""><i class="i7"></i>我的钱包</a>
            </div>
            <div class="content">
                <div class="hd">
                    <strong>我的信息</strong>
                ...
                <div class="userinfo">
                    <form action="" method="post" accept-charset="utf-8">
                        <dl class="clearfix">
                            <dt>名号：</dt>
                            <dd>
                                <input type="text" name="name" value="${login_user.user_name }">
                            </dd>
                        </dl>
                        <dl class="clearfix">
                            <dt>性别：</dt>
                            <dd>
                                ...
                                <label>
                                    <span class="cssradio">
                                        <input type="radio" name="gender" value="0" checked="false">
                                        <span></span>
                                    </span>女
                                </label>
                                <label>
                                    <span class="cssradio">
                                        <input type="radio" name="gender" value="2" checked="false">
                                        <span></span>
                                    </span>保密
                                </label>
                            </dd>
                        ...
                        <dl class="clearfix">
                            <dt>居住城市：</dt>
                            <dd>
                                <input type="text" name="name" value="${login_user.user_address }">
                            </dd>
                        </dl>
                        <dl class="clearfix">
                            <dt>出生日期：</dt>
                            <dd>
                                <input type="text" name="name" value="${login_user.user_date }">
                            </dd>
                        </dl>
                        <dl class="clearfix">
                            <dt>个人简介：</dt>
                            <dd>
                                <textarea name="" placeholder="${login_user.user_text }" ></textarea>
                            </dd>
                        </dl>
                        <dl class="clearfix">
                            <dt>收货地址：</dt>
